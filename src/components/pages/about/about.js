      ...
      <section className={styles.about}>
        ...
        <div className={styles.aboutContainer}>
          <div className={styles.about__image}>
            <img src={imageCleo} alt="cleochildminding Cecile" />
          </div>

          <div className={styles.aboutContentDescription}>
            <p>
            ...
            <p>
              I hope to share my enthusiasm for authentic learning, the wonders
              of nature and the challenges outdoors experiences can offer.
            </p>
          </div>
          ...
          <div className={styles.aboutContent}>
            ...
            <p>
              ...
              maximum of 6 children under 16 at any one time, of whom no more
              than three are not yet attending primary school, and no more than
              one is under 1. These numbers include her own children.
            </p>
          </div>
          ...
          <div className={styles.aboutContent}>
            ...
            <p>
              ...
              environment to play in and opportunities to grow and to build on
              the children’s natural curiosity. In my parenting and as a
              childminder I use a gentle approach. I have a real passion for
              child-led inquiries, authentic learning opportunities and outdoor
              experiences.
            </p>
            <p>
              I am passionate about my role as a childminder and will work hard
              to provide your child with the best possible care service that I
              can.
            </p>
            ...
            <ul>
              <li>
                ...
                outdoors and beyond in which children feel happy, safe and
                secure.
              </li>
              <li>Listen to your child, their interests and feelings.</li>
              <li>
                Provide a wide variety of activities taking your child’s
                interests and developmental stages into account.
              </li>
              <li>
              ...
              <li>
                Develop moral values that promote consideration for individual
                and cultural differences.
              </li>
              <li>
                Offer an environment in which English and French are both part
                of and in which all cultures and languages are welcome and
                celebrated.
              </li>
              <li>
